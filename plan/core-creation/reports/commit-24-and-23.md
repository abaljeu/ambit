...
[[../issues/24-clarify-core-increment-boundary.md]] and [[../issues/23-close-core-object-seam.md]] are Status `done`. Project Stage stays `active`. The skills-cleanup summary and row-order diff was not a Core creation Stage change.
