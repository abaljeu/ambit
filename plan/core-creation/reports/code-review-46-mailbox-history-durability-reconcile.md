# code-review — [46 — Mailbox History durability](../issues/46-mailbox-history-durability.md) reconcile
...
Range: three-dot `origin/staging` (`77f47cf2`) ... tip `ea1d1af2` of [PR 41](https://github.com/abaljeu/ambit/pull/41) branch `cursor/46-live-append-eventid-max-676f`. Authority: Alan's load compare on the ticket What to build, plus the user Spec for this review. [46 mailbox History durability reconcile](46-mailbox-history-durability-reconcile.md) is the correction note. Empty→zero and EventId.max tip patches are not Spec.
...
3. **Hard — refer by name.** [refer-by-name.md](../../../.agents/rules/refer-by-name.md): never refer by only the id. Scan BARE_ID: [code-review-46-mailbox-history-durability-rereview.md](code-review-46-mailbox-history-durability-rereview.md) lines 28–31 and 39 (`item 9`, `item 4`); [code-review-46-mailbox-history-durability.md](code-review-46-mailbox-history-durability.md) lines 53, 67, 73 (`item 9`, `item 4`). Added prose also uses bare `46` / `35b` / `34b` / `42` in [project.md](../project.md) (“does not need 46”, “does not depend on 46”), [46 mailbox History durability](46-mailbox-history-durability.md) (“without 46”), and [46 mailbox History durability explore](46-mailbox-history-durability-explore.md) (“Old 34b names”, “Single-event 42 tests”, “without 46”).
