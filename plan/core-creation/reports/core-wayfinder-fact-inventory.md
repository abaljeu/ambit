...
8. **Tracker guidance names the wrong root.** [[doc/agents/issue-tracker.md]] and [[doc/agents/project-status.md]] repeatedly define the tracker under .scratch, while [[CONTEXT.md]] and the live repository use plan. This makes the required Wayfinder file shape unclear.
