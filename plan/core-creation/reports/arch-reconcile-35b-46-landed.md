...
See also: [Core creation architecture](../arch.md), [35b — Browser Run hello](../issues/35b-browser-run-hello.md), [49 — Mailbox History durability](../issues/49-mailbox-history-durability.md).
...
7. EventLog durability / load reconcile prose (Feature recover, module **EventLog** Interface 9, module **PersistHandlers** Interface 4, Alternative **Chosen Event destination**) — [49 — Mailbox History durability](../issues/49-mailbox-history-durability.md)
...
Ticket status: [35b — Browser Run hello](../issues/35b-browser-run-hello.md) is `done`. [49 — Mailbox History durability](../issues/49-mailbox-history-durability.md) stays `done`.
