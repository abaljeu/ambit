...
- 2026-09-20 — Filed [[issues/51-browser-run-focus-vs-command.md|51 Browser Run Focus vs Command]]: Focus = reply parent; Command = `?` ancestor; one-Node stays hello-only. Status `defined`.
...
- [51 — Browser Run: Focus reply parent, Command is `?` ancestor](plan/core-creation/issues/51-browser-run-focus-vs-command.md) — Product AI Run distinct focusId/commandId; Status `defined`.
