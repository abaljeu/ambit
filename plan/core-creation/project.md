...
- [[plan/core-creation/issues/13-delete-runtime-mirror-and-remove-production-persistence-mode.md]] — use Database persistence when available and reject Changes when unavailable. Status `coded`.
...
- [35b — Browser Run hello](issues/35b-browser-run-hello.md) — Story path **Browser Run hello**: `?` one-Node Command through HTTP to Owned child `hello`. Status `done`.
- [46 — Mailbox History durability](issues/46-mailbox-history-durability.md) — persist/load the audit sequence; load reconcile Graph id vs EventLog tip (drop / noop / apply until concurrent). Status `done`.
...
- [Arch reconcile 35b and 46 landed](reports/arch-reconcile-35b-46-landed.md) — [Core creation architecture](arch.md) checkboxes after [35b — Browser Run hello](issues/35b-browser-run-hello.md) and [46 — Mailbox History durability](issues/46-mailbox-history-durability.md). Remaining unchecked → covering ticket.

## Comments

- 2026-09-19 — Implemented [13 — Delete runtime mirror and remove production Persistence:Mode](issues/13-delete-runtime-mirror-and-remove-production-persistence-mode.md). Status `coded`. Report: [13 — Delete runtime mirror Persistence:Mode](reports/13-delete-runtime-mirror-persistence-mode.md).
...
- 2026-09-18 — Spec-review approve → `done`: 33, 36, 37, 40, 41, 42. Arch reconciled after 35b/46 (report [[plan/core-creation/reports/arch-reconcile-35b-46-landed.md]]).
...
- 2026-09-18 — Implemented [46 — Mailbox History durability](issues/46-mailbox-history-durability.md). Status `done`. Report: [46 mailbox History durability](reports/46-mailbox-history-durability.md).
...
- 2026-09-19 — Live `appendEvent` on [46 — Mailbox History durability](issues/46-mailbox-history-durability.md) keeps a Graph-ahead tip (`EventId.max`). Status stays `coded`. Note: [46 mailbox History durability live-append tip](reports/46-mailbox-history-durability-live-append-tip.md). Re-review: [code-review-46-mailbox-history-durability-rereview](reports/code-review-46-mailbox-history-durability-rereview.md).
- 2026-09-19 — Alan load reconcile on [46 — Mailbox History durability](issues/46-mailbox-history-durability.md): drop / noop / apply until concurrent. Status stays `coded`. Note: [46 mailbox History durability reconcile](reports/46-mailbox-history-durability-reconcile.md).
