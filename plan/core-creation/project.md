...
- [[plan/core-creation/issues/35b-browser-run-hello.md|35b — Browser Run hello]] — Story path Browser Run hello: `?` one-Node Command through HTTP to Owned child `hello`; Status `ready-for-agent` (34b `done`). §6 durability → [[plan/core-creation/issues/46-mailbox-history-durability.md|46]]; §7 proof does not need 46.
- [[plan/core-creation/issues/46-mailbox-history-durability.md|46 — Mailbox History durability]] — Split from 35b §6: mailbox History survives restart. Status `defined`. Blocked by [[plan/core-creation/issues/35b-browser-run-hello.md|35b — Browser Run hello]]. Not required for 35b §7 Browser proof.
...
- 2026-09-18 — Split 35b §6 to [[plan/core-creation/issues/46-mailbox-history-durability.md|46 — Mailbox History durability]]; §7 Browser proof does not depend on 46.
