...
- 2026-09-19 — Chrome tickets expanded: [21 — Client shows live Actor](plan/core-creation/issues/21-client-shows-lock-present.md) owns start result (“Run: AI started.”), Command/Poll Event apply, chrome, boot live set, Poll stop/error conveyance; [22 — Client cancels a job](plan/core-creation/issues/22-client-cancels-a-job.md) owns cancel control on live chrome. DLL provider error naming is a separate ticket.
