...
- [53 — Cancel HTTP conveys ActorStop](plan/core-creation/issues/53-cancel-http-conveys-actorstop.md) — Cancel HTTP success carries Cancelled `ActorStop` Events; Client applies them; no wrong-Focus stop after finish. Status `done`.
