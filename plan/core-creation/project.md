...
- 2026-09-20 — Filed [[issues/50-actor-live-labels-from-command.md|50 Actor live result labels from Command node]]: cancelled — folded into 21 failed-review rework.
...
- [50 — Actor live result labels from Command node](plan/core-creation/issues/50-actor-live-labels-from-command.md) — Cancelled — folded into 21. Status `cancelled`.
