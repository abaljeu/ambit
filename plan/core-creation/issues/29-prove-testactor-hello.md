...
- [ ] Command text `?test hello` launches TestActor hello.
...
- [ ] TestActor posts one hello Change of Owned children under Focus, then queues Succeeded.
...
- [ ] This increment does not include live query, cancel, host-stop, fail, post-twice, duplicate terminal, Interrupted restart, Browser chrome, or Actor definitions other than TestActor.
