...
Moved to [49 — Mailbox History durability](49-mailbox-history-durability.md). Not required for [§7 Browser proof](35b-browser-run-hello.md).

### 7. Browser proof

Verify the complete Story path from the user-visible boundary. Does **not** require [49 — Mailbox History durability](49-mailbox-history-durability.md).
...
- 2026-09-18 — [§6 History durability](35b-browser-run-hello.md) split to [49 — Mailbox History durability](49-mailbox-history-durability.md). [§7 Browser proof](35b-browser-run-hello.md) can run without 49.
