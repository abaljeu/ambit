...
- 2026-09-18 — Unused [EventId.fs](src/Shared/EventId.fs) was already gone from the historical [12 — Contract leftover Change and Revision](12-contract-leftover-change-and-revision.md) land. Green bar: file absent; EventId lives in [History.fs](src/Shared/History.fs). Alan said done.

## Time

- 2026-09-18 10m — Confirm unused EventId.fs already absent; no file to delete
