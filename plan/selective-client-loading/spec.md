...
- Client eviction, re-unloading, passive reclamation, memory budgets, pin sets, or IndexedDB/offline startup caches. Those caches belong to fast reboot ([[plan/client-start-time/reports/cache-first-boot-via-poll.md]]), not this project.
