...
6. **Architecture** — [[arch.md]]; Sequence `module-build`; coding tickets under [[map.md]] Implementation (01–03 product modules; 04 TestActor `?test gbot` simulation; 05 first-slice Finish-on-response-end; 06 Done-seam research).
