...
**Context:** Run accepts only `=` Expression and `Name=Expression`; any other line does nothing. Ask from what I see needs a third form `?` plus a message. Pack, LLM call, and write-back belong to [[plan/llm-connector/project.md]]. Do not implement those here.
...
**See also:** [[../spec.md]] chapter 8; [[21-run-consumer-equals-and-name-equals-statements.md]]; [[plan/llm-connector/map.md]]; [[plan/roadmap/epics/agent-chat-managed-context.md]].
