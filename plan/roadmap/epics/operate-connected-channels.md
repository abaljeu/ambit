# Operate connected channels

Stage: charting

A person connects an outside channel and operates it from Ambit with an Agent.
...
- Chapters stay open-ended: add one when a specific channel or beat is named.
