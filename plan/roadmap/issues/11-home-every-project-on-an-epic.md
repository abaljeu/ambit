...
Every feature-set Project should appear on the Roadmap. Interview Project by Project: which Epic(s) it enables. Multiple Epics are allowed. A piece of a Project may home separately; then reassess the remainder. Coverage is Homed Projects on the Epic, not stuffing every Project into the current Chapter.

## Comments

- 2026-08-30: Coverage, not a second map index. Enablers that are bugs or misfeatures still home on the use they unblock.
- 2026-08-30: New standing Epics [[epics/organize-huge-outlines.md]] (scaling, not first use; other Epics reference it) and [[epics/robust-outliner.md]] (integrity). Both exist to home Projects; there is nothing to chart on them.
