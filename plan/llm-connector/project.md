...
- [18 — AI Actor stream](issues/18-ai-actor-stream.md) — Status `coded`. Follow-up: Actor consumes CloudAgents stream; pending-buffer incremental Focus children; tidy replace only when no element was committed.
