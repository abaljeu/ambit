...
- 2026-09-19 — Coded [08 — Agent ask from what I see](issues/08-agent-ask-from-what-i-see.md): `setFake`, Run Agent Actor, Amb pack, Focus-child replace. Status `coded`.
...
- [[issues/08-agent-ask-from-what-i-see.md|08 — Agent ask from what I see]] — Status `coded`.
