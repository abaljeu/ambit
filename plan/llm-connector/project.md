...
- [19 — AI extract pack is XML with Focus cssClass](issues/19-ai-xml-pack-focus-css.md) — Status `coded`. Follow-up: write-only XML CloudAgents document; Focus css class on the extract copy.
