...
- [25 — Grok Bot wake auth Bearer](issues/25-grokbot-wake-auth-bearer.md) — Status `defined`. Follow-up: lock wake auth as `Authorization: Bearer {WakeSecret}`; replace invented `X-Ambit-Wake-Secret`.
