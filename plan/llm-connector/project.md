...
- [24 — CloudAgents Grok Bot oneshot stream](issues/24-cloudagents-grokbot-oneshot.md) — Status `coded`. Follow-up: sibling oneshot `GrokBotRunner` (wake ack-only, fake Done, cancel). Server Actor gbot wiring out of scope.
