...
- Both routers dropped every `plan/index.md` reference. None were added. The retired [[.agents/skills/projects-overview/SKILL.md]] catalog line no longer names that file.
...
- Search of the two routers finds no `plan/index.md`, setup-matt, or update-matt-skills. `triage-labels.md` remains the Status list pointer on gambol only.
...
- [[.agents/skills/projects-overview/SKILL.md]], [[.agents/rules/project-stage.md]], [[.agents/skills/project-work/SKILL.md]], and [[doc/agents/project-status.md]] still name `plan/index.md`. Out of this edit set.
