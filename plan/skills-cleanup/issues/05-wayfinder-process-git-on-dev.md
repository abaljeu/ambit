...
- [x] Wayfinder points at [[doc/agents/issue-tracker.md]] for claim, Type, Status, frontier, and file layout. It does not repeat those ops.
- [x] Wayfinder does not teach `research/<name>` places or GitHub assignee / label / close verbs.
- [x] Prototype does not teach `prototype/<name>` places. Capture stays on `dev`.
...
- 2026-09-06 50m — pointed Wayfinder at the tracker; prototype capture on `dev` (from chat)
