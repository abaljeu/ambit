...
- [ ] request-refactor-plan creates and charts a new Feature-set Project under [[plan/]].
- [ ] The skill points at [[doc/agents/issue-tracker.md]] and project-work for structure. It does not repeat those docs.
