...
- [ ] Delete-against-edit wrapper recovery is explicitly accepted, revised, or rejected, including whether Changes need an explicit baseline for history scan.
