...
**Context:** Producers that only mean “add these children” should not hand-build a full-list Replace against the parent’s current children. **Streaming agents**, including the forthcoming **gbot** implementation, **may use Append**. Primary consumers: [18 — AI Actor stream](../../llm-connector/issues/18-ai-actor-stream.md) FocusXmlStream pending-buffer writes, and the [bot-channel](../../bot-channel/project.md) gbot inbox→Focus path (ticket 03). Append is the preferred producer face for “add these children at the end of Focus/parent.” Mailbox Change already has `Replace(parentId, oldChildren, newChildren)` ([[../../../src/Shared/History.fs]]). [13 — Migrate producers to full-list Replace wire shape](13-migrate-producers-full-list-replace-wire.md) and [14 — Drop Replace index (§10 wire migration)](14-drop-replace-index-wire-migration.md) are `done`, so that contract is the expansion target. This ticket adds an in-process **Append** face that execute expands to Replace before History records. It is not [11 — Completing-ops pattern beyond timing](11-completing-ops-pattern-beyond-timing.md) (Server fill-in of missing Ops when an Actor’s view is too small).
...
**See also:** [[../details/replace-amendment.md]], [[../../../src/Shared/History.fs]], [[../../../src/Shared/ClientHistory.fs]] (`mintChange`), [[../../../src/Server/GraphOnlyChangePost.fs]], [18 — AI Actor stream](../../llm-connector/issues/18-ai-actor-stream.md), [[../../bot-channel/project.md]] (gbot inbox→Focus; ticket 03)
