...
Out of scope for a Project is not a Committed Decision. Do not infer product exclusions from specs, maps, roadmap leftovers, or code absence. See [[docs/agents/scope-vs-commitment.md]].
