...
- [ ] Manual/HITL check: hovering a chevron, a solid-circle leaf, and a hollow-circle leaf each show the expected tip text with no change to click/double-click/fold/zoom behavior.
