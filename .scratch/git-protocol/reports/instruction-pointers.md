...
- [[.cursor/rules/gambol.mdc]] — lists git-protocol; project-work is `.scratch` files and Stage
...
- [[docs/Decisions/0001-agent-git-hygiene.md]] — superseded; body is a pointer
- [[docs/Decisions/0002-git-protocol.md]] — new; points at the skill

Project:

- [[.scratch/git-protocol/project.md]] — Stage `active`
- [[.scratch/index.md]] — Git protocol row
...
- [[docs/agents/]] — no branch protocol

Not rewritten (per request): `.scratch/**/git.md` history, `.scratch/done/` forks, `src/`, [[scripts/merge.sh]] (absent).
...
5. [[.scratch/daily-git-save/project.md]] — application `commitAll` of DataDir (not agent git). `src/` not edited.
6. [[.scratch/done/update-matt-skills/forks/]] — forks of implement, request-refactor-plan, code-review, diagnosing-bugs, resolving-merge-conflicts still describe `w/*`. Not rewritten. The next flatten plus fork re-apply can restore a competing protocol — **diverging; needs human**.
