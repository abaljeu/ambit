...
Recorded the HITL lock on [[.scratch/expression-language/issues/11-keep-or-drop-amble-of-and-comma.md|Keep or drop Amble of and comma]]. Status is resolved.
...
- [[.scratch/expression-language/issues/03-first-primitive-catalog.md|First primitive catalog]]: `of` dropped from later-word list.
- Map [[.scratch/expression-language/map.md]] Decisions so far: 11 gist added.
- [[.scratch/expression-language/spec-draft.md]] catalog out-of-slice: `of` dropped.
