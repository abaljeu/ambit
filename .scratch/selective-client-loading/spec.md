...
45. As a user deleting or permanently deleting content, I want existing delete, TRASH, permanent-delete, and Undo behavior preserved because ROOT is fully loaded, so that selective loading does not require a server-only delete command.
