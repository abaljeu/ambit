...
28. As a user, I want ChangeRequest submission and Poll, bootstrap, and Load Change responses serialized through one global single-flight synchronization state, so that responses cannot race or apply out of order.
