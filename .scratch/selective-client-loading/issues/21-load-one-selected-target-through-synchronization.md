...
- [ ] Loading a target with Loaded children requests no Workspace package and still receives the normal ordered ChangeRequest catch-up.
- [ ] The ChangeRequest tail and any Workspace package are captured at one response revision and install as one coherent client transition.
