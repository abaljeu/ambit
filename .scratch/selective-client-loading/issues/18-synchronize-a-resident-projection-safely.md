# 18 — Apply catch-up ChangeRequests under Loaded rules
...
**Blocked by:** 15 — Introduce ChangeRequest messaging; 17 — Represent unloaded child lists end to end.
...
- [ ] Ordered Change, Undo, and Redo ChangeRequests apply structural effects only to Loaded child lists and apply nonstructural facts to resident Node headers.
- [ ] An action concerning an absent header has no projected graph effect, while every received revision and complete ChangeRequest remains in projected History.
