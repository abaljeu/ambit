...
| [Event-sourced ops](event-sourced-ops/) | charting | Async framework increment 1 locked (Op/Change/Actor/Merge); next is conflict kinds; sibling of relaxed-concurrency. |
