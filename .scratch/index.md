...
| [Search zoom select](search-zoom-select/) | done | Find pick must zoom to the target's owner parent, then select the target (align with focusNode / tryReframeZoomAtOwnerParent). |
