...
| [Event-sourced ops](event-sourced-ops/) | active | One semantic standard for how any Actor's Change enters a Graph — twelve implementation issues (`issues/01`–`12`) from critical-flaw elimination through Actor spine, recovery decisions, and polish; charting docs in overview, architecture, and details. |
