...
Each item is project-sized (likely its own `.scratch/<slug>/`). Status words follow [[overview.md]]. Prefer fewer concepts: merged tickets where lifecycle is one surface.
