...
- [x] After an external-changes Post signal, `#sync-status` shows remote catch-up is pending until the queue-empty Poll replay finishes (not `ServerRejected` / reload).
