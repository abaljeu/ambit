...
- 2026-08-29 Q1: Visitors open a public URL and read pages without the App. Not export-elsewhere; not the documents-from-anywhere audience.
- 2026-08-29 Q2: Wiki page and published page are the same family. Options A/B/C all apply at some grain; presentation and needs vary greatly at the detail level. Do not treat them as unrelated artifacts, and do not collapse the two Epics.
- 2026-08-29 Q3: HTML as a codec is in scope now (overrides XML-format “HTML excluded”). Not Graph-only public HTML with no File class.
- 2026-08-29 Q4: Author in the App as today; this Epic is the public URL presentation.
...
- 2026-08-29 Q12: Write the Epic only. No follow-up tickets or wiki issues this session.
- 2026-08-29: Named Chapter **In-app styling** (HTML look in the App). Not Published-page CSS.
