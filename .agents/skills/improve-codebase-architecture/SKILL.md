...
- The domain language in [[CONTEXT.md]] gives names to good seams; Committed Decisions under [[doc/Decisions/]] record decisions this command should not re-litigate.
...
Read the project's domain glossary ([[CONTEXT.md]]) and any Committed Decisions in the area you're touching first.
