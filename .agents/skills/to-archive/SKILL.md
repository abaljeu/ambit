...
3. Regenerate [[plan/index.md]] with [[.agents/skills/projects-overview/SKILL.md]]. Completion: the archived project no longer appears.
4. Finish as **agent-done** per [[.agents/skills/git-protocol/SKILL.md]].
