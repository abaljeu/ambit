...
**Context** is the situation the change applies in (who is doing what, before the new behaviour). **What to build** is that new behaviour from that person's view, not a layer-by-layer list.
