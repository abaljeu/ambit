...
Create issue files in dependency order (blockers first) so you can reference sibling paths/numbers under the same feature.
...
- NN (sibling issue number) if blocked; else "None — can start immediately"
