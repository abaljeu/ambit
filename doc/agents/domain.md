...
When documenting what Gambol excludes or will not do, follow [[doc/agents/scope-vs-commitment.md]] — scope is effort-local; commitment requires an authorized record.
