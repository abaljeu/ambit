...
- [[.scratch/selective-client-loading/issues/20-restore-saved-zoom-workspace-during-bootstrap.md]] — `/state` Graph: ROOT ± at most one saved-zoom Workspace; folds don’t widen residency (parent: [[.scratch/selective-client-loading/spec.md]])
...
- [[.scratch/selective-client-loading/issues/23-make-hollow-circle-clicks-invoke-load.md]] — dispatch full-selection Load from the hollow-circle affordance (blocked by: [[.scratch/selective-client-loading/issues/22-load-full-selection.md]])
