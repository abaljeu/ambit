...
- [[.scratch/expression-language/issues/20-pure-filter-catalog-rows.md]] — `named`, classification filters (`ws`/`dir`/`file`/`normal`), `class` (branch: `w/expr`; report: [[.scratch/expression-language/reports/tickets-17-19-implementation.md]])
