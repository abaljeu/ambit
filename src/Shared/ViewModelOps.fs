...
module ViewModel =
    ...
    let captureFoldOccurrences = ViewModelSiteMap.captureFoldOccurrences
    let restoreFoldOccurrences = ViewModelSiteMap.restoreFoldOccurrences
    ...
    let firstGraphChild = ViewModelOccurrence.firstGraphChild
    let resolveZoomRoot = ViewModelOccurrence.resolveZoomRoot
    let retargetZoomIfMissing = ViewModelOccurrence.retargetZoomIfMissing
